...
function Main(props) {
    ...
    const [interxType, setSelectorType] = useState(null)
    ...
    const updateParamFields = () => {
        ...
        if (interxType === 'QUERY') {
            ...
            if(metaType.isPlain) {
                ...
                paramFields = [
                    {
                        name: metaType.asMap.key1.toString(),
                        type: metaType.asMap.key1.toString(),
                        optional: false,
                    },
                    {
                        name: metaType.asMap.key2.toString(),
                        type: metaType.asMap.key2.toString(),
                        optional: false,
                    }
                ]
            }
            ...
            if (metaParam.length > 0){
                paramFields = metaParam.map(arg => ({
                    name: arg.name,
                    type: arg.type,
                    optional: arg.argIsOptional || false,
                }))
        }
    ...
    const getOptionalMsg = interxType =>
        interxType === 'RPC'
        ? 'Optional Parameter'
        : 'Leaving this field as blank will submid a NONE value'
